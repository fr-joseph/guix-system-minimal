(define-module (fj home-services pipewire)
...
(define (my-home-pipewire-xdg-configuration-service config)
  `(("alsa/asoundrc"
     ,(mixed-text-file
       "asoundrc"
       #~(string-append
...
(define my-home-pipewire-service-type
  (service-type (name 'my-home-pipewire)
                (extensions
                 (list (service-extension
                        home-profile-service-type
                        my-home-pipewire-profile-service)
                       (service-extension
                        home-shepherd-service-type
                        my-home-pipewire-shepherd-service)
                       (service-extension
                        home-xdg-configuration-files-service-type
                        my-home-pipewire-xdg-configuration-service)))
                (default-value #f)
