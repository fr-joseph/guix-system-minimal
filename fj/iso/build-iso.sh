...
guix time-machine -C './base-channels.scm' -- \
     describe -f channels > './channels.scm'

# Build the image
printf 'Attempting to build the image...\n\n'
image=$(guix time-machine -C './channels.scm' --substitute-urls='https://ci.guix.gnu.org https://bordeaux.guix.gnu.org https://substitutes.nonguix.org' -- system image -t iso9660 './installer.scm') \
