...
if [ "$1" -eq "1" ]; then
    ...
    note "now copy the config file to /mnt/etc/system.scm, and then run this command to complete the installation:"
    note "  guix system init /mnt/etc/system.scm /mnt"
